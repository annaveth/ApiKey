...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ApiKey processing");
    
    let mut processor = ApiKeyProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ApiKeyProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ApiKeyProcessor::new(false);
